package com.kosign.push.utils.enums;
...
public enum ExceptionEnum {
    ...
    Message();
    public final String P8_FILE_NOT_FOUND = "P 8 File Not Found";
    public final String REGISTERED_PLATFORM_SETTING = "Registered Platform Setting";
    public final String SETTING_NOT_FOUND = "Setting Not Found";
